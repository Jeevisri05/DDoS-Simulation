...
proc finish {} {
	...
	close $namfile
	exec nam out.nam &
	exec awk -f cal_udp.awk out.tr &
	exec awk -f node4.awk out.tr &
	exec awk -f node4_1.awk out.tr &
	exec awk -f node9_1.awk out.tr &
	exec awk -f node15_1.awk out.tr &
	exec awk -f node16_1.awk out.tr &
	exec awk -f node9.awk out.tr &
	exec awk -f node15.awk out.tr &
	exec awk -f node16.awk out.tr &
	exit 0
}
